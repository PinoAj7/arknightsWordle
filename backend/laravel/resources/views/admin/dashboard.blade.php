...
<body class="relative min-h-screen flex flex-col text-gray-800">
    ...
    <div class="relative z-10 flex flex-col flex-grow">
        ...
        <main class="container mx-auto max-w-xl p-4 sm:p-4 md:p-4 flex-grow">
            <div class="bg-white p-6 sm:p-6 md:p-6 rounded shadow space-y-6">

                <h2 class="text-xl sm:text-xl md:text-xl font-semibold mb-4">Opciones de Administración</h2>

                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <a href="{{ route('admin.users.index') }}" class="block p-6 sm:p-6 md:p-6 bg-blue-500 text-white rounded hover:bg-blue-600 transition text-center font-medium">
                        Gestión de Usuarios
                    </a>

                    <a href="{{ route('admin.characters.index') }}" class="block p-6 sm:p-6 md:p-6 bg-green-500 text-white rounded hover:bg-green-600 transition text-center font-medium">
